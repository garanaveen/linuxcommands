...
#Rename the file to input.pdf and excute this bash script.
#This will generate 5 files with different resolution rates. Choose the one that meets your file size requirements.
