...
#Check if there are any incoming/outgoing messages from remote,
#find . -maxdepth 2  -mindepth 1 -name .git -type d -exec sh -c 'cd $0 ; cd ../ ; pwd ; git fetch && git log master..origin/master; cd ..' {} \;
